...
void inj_ign(void){
    ...
    if(adc_clt<temp_limit){inj_ms_base=inj_ms_base-inj_temp;}
...
void data_send(void){
   ...
   rpm,adc_tps,inj_ms_perc,inj_ms_tick,ign_off_deg,ign_off_tick,one_deg_tick,id_rpm,id_tps,inj_open_time,inj_ms_base,adc_clt
  );
}
